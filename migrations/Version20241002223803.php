 ...
 */
final class Version20241002223803 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, date_event DATE NOT NULL, lieu VARCHAR(255) NOT NULL, video VARCHAR(255) DEFAULT NULL, image VARCHAR(255) NOT NULL, date_ajout DATE NOT NULL, passee TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
